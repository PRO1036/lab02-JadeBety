...
La couleur se trouve avec aes puisque cette dernière est du maping (détermine une propriété en fonction d'une propriété des données) tandis que la transparence est du setting (fixer une propriété), donc elle est réglé dans geomdensity.
